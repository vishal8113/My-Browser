...
import com.vishal.mybrowser.activity.BookmarkActivity
...
import com.vishal.mybrowser.adapter.BookmarkAdapter
import com.vishal.mybrowser.databinding.FragmentHomeBinding
        ...
        binding.searchView.setOnQueryTextListener(object: SearchView.OnQueryTextListener{
            override fun onQueryTextSubmit(result: String?): Boolean {
                if(checkForInternet(requireContext()))
                    ...
                    Snackbar.make(binding.root, "Internet Not Found!\uD83D\uDE42",3000).show()
                return true
            }
